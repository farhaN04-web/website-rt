...
if (isset($_GET['id'])) {
    ...
    if (mysqli_stmt_execute($stmt_delete)) {
        header("Location: berita/kelola_berita.php?status=hapus_sukses");
    } else {
        header("Location: berita/kelola_berita.php?status=hapus_gagal");
    }
    mysqli_stmt_close($stmt_delete);

} else {
    header("Location: berita/kelola_berita.php");
}
?>