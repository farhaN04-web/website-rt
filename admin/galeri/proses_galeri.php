...
if (isset($_POST['simpan'])) {
    ...
    if (mysqli_stmt_execute($stmt)) {
        header("Location: galeri/kelola_galeri.php?status=sukses");
    } else {
...
elseif (isset($_POST['update'])) {
    ...
    if (mysqli_stmt_execute($stmt)) {
        header("Location: galeri/kelola_galeri.php?status=update_sukses");
    } else {
        header("Location: galeri/kelola_galeri.php?status=update_gagal");
    }
    mysqli_stmt_close($stmt);
}
