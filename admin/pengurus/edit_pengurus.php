...
<div class="container-fluid">
    ...
    <div class="card mb-4">
        <div class="card-body">
            <form action="pengurus/proses_pengurus.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <img src="../assets/img/<?= htmlspecialchars($data['foto'] ?: 'default.png'); ?>" width="100" class="img-thumbnail mb-2">
                    <input type="file" class="form-control" id="foto" name="foto" accept="image/*">
                    <small class="text-muted">Kosongkan jika tidak ingin mengubah foto.</small>
                </div>
                <button type="submit" name="update" class="btn btn-primary">Update Data</button>
                <a href="pengurus/kelola_pengurus.php" class="btn btn-secondary">Batal</a>
            </form>
        </div>
    </div>
</div>
